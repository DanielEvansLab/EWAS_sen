...
## Noob preprocessing
Can I reproduce the results I previously generated using noob data from Nate? 

This code chunk creates a noob processed dataset from the raw data. Should be the same as data from Nate.

Output is a matrix of betas. 
...
Now perform t-test using the newly created noob processed data. Are my new results the same as my old results? 
